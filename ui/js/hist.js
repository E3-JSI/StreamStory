...
function drawHistogram(opts) {
    ...
    if (opts.formatX == null) opts.formatX = function (val) { return val + ''; }
    if (opts.formatY == null) opts.formatY = function (val) { return (val*100).toFixed() + '%'; }
    ...
    var margin = {
        left: opts.leftPadding,
        right: opts.rightPadding,
        top: opts.topPadding,
