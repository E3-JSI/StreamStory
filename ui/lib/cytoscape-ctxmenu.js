  ...
  var register = function( cytoscape, $ ){
    ...
    function createMenuItems() {
      ...
      function addEventListeners(){
        ...
        bindings
          .on('cxttapstart'/*'cxttapstart taphold'*/, options.selector, function(e){
          ...
          .on('cxtdrag'/*'cxtdrag tapdrag'*/, options.selector, dragHandler = function(e){
          ...
          .on('cxttapend'/*'cxttapend tapend'*/, options.selector, function(e){
            var ele = this;
            $parent.hide();
          ...
          .on('cxttapend'/*'cxttapend tapend'*/, function(e){
            $parent.hide();
