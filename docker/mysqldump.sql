...
INSERT INTO `config` VALUES ('calc_coeff','true'),('deviation_extreme','5'),('deviation_extreme_lambda','3.888'),('deviation_major','4'),('deviation_major_lambda','0.648'),('deviation_minor','2'),('deviation_minor_lambda','0.05'),('deviation_significant','3'),('deviation_significant_lambda','0.1');
...
INSERT INTO `model` VALUES (30,'Weather 1','','luka@lstopar.si','/mnt/raidM2T/project-data/StreamStory-meeting/offline-db/luka@lstopar.si/1467622620053/StreamStory.bin','rainfall-england.csv',0,'2016-07-04 08:57:00',0),(31,'GEO Example','','luka@lstopar.si','/mnt/raidM2T/project-data/StreamStory-meeting/offline-db/luka@lstopar.si/1467735345720/StreamStory.bin','export_loc_luka-out-new.csv',0,'2016-07-05 16:15:50',0);
...
INSERT INTO `offline_model` VALUES (30,'/mnt/raidM2T/project-data/StreamStory-meeting/offline-db/luka@lstopar.si/1467622620053'),(31,'/mnt/raidM2T/project-data/StreamStory-meeting/offline-db/luka@lstopar.si/1467735345720');
...
-- Dump completed on 2016-07-11 14:03:38
